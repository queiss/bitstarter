...
var URL_DEFAULT = "http://secret-fortress-1629.herokuapp.com";
...
var cheerioUrl = function(urlstring, checksfile) {   
...
var checkUrl = function(urlstring, checksfile) {
    cheerioUrl(urlstring, checksfile);
};
...
if(require.main == module) {
    program
        ...
        .option('-u, --url <url>', 'URL for index.html', clone(assertUrlExists), URL_DEFAULT) 
        .parse(process.argv);
